        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HuellaContenido = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    NivelAcceso = table.Column<int>(type: "integer", nullable: false),
                    CantidadFragmentos = table.Column<int>(type: "integer", nullable: false),
                    ModeloEmbeddings = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Carga = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: false),
                    ...
                    Milisegundos = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_fragmentos_documentos_DocumentoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_documentos_NombreArchivo",
                schema: "mesa",
                table: "documentos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_eventos_FechaCreacion",
                schema: "mesa",
                table: "eventos",
                column: "FechaCreacion");

            migrationBuilder.CreateIndex(
                name: "IX_eventos_Huella_Resultado",
                schema: "mesa",
                table: "eventos",
                columns: new[] { "Huella", "Resultado" });

            migrationBuilder.CreateIndex(
                name: "IX_fragmentos_DocumentoId_Orden",
                schema: "mesa",
                table: "fragmentos",
