...
public static class ExtensionesServicios
{
        ...
        IConfiguration configuracion)
    {
        ...
        // Modulo del agente
        servicios.Configure<OpcionesAgente>(configuracion.GetSection(OpcionesAgente.Seccion));
        servicios.AddScoped<IHerramientaAgente, HerramientaBuscarSolicitudes>();
        servicios.AddScoped<IHerramientaAgente, HerramientaDetalleSolicitud>();
        servicios.AddScoped<IHerramientaAgente, HerramientaEstadisticas>();
        servicios.AddScoped<IHerramientaAgente, HerramientaConsultarReglamento>();
        servicios.AddScoped<IHerramientaAgente, HerramientaCambiarEstado>();
        servicios.AddScoped<ServicioAgente>();
        servicios.AddScoped<ServicioReporte>();

        // Modulo de orquestacion
        servicios.Configure<OpcionesOrquestacion>(configuracion.GetSection(OpcionesOrquestacion.Seccion));
        servicios.AddScoped<ServicioIngreso>();
        servicios.AddScoped<ServicioAuditoria>();
